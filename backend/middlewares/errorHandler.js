module.exports = (err, req, res, next) => {
  ...
  // Uma exceção pode ser gerada ao tentar acessar o banco de dados ou o código pode
  // simplesmente travar, não tendo, o erro, a propriedade statusCode. Esses casos, neste
  // projeto, são considerados como um erro do servidor (500), com status e mensagem
  // padrões definidos
